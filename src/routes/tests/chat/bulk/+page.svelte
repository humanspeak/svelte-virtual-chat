...
<div class="p-4">
    ...
    <div class="mb-3 flex gap-2">
        <button onclick={() => load(100)} data-testid="load-100" class="rounded bg-blue-500 px-3 py-1 text-sm text-white">
            100
        </button>
        <button onclick={() => load(1000)} data-testid="load-1000" class="rounded bg-blue-500 px-3 py-1 text-sm text-white">
            1,000
        </button>
        <button onclick={() => load(5000)} data-testid="load-5000" class="rounded bg-blue-500 px-3 py-1 text-sm text-white">
            5,000
        </button>
        <button onclick={() => load(10000)} data-testid="load-10000" class="rounded bg-blue-500 px-3 py-1 text-sm text-white">
            10,000
        </button>
        <button onclick={clear} data-testid="clear" class="rounded bg-red-500 px-3 py-1 text-sm text-white">
            Clear
        </button>
    </div>
