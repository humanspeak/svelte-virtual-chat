...
| 002  | Decide whether CSS scroll anchoring can give follow-bottom a pre-paint guarantee    | P1       | L      | 001        | DONE (2026-07-09) — red pre-fix: chromium stress 2/3 failed, maxGapPx=408; signed oracle also measured before-with-library-stashed `same-id` maxGapPx=24 and caught WebKit blank-space maxGapPx=521. Strategies: viewport scroll anchoring, content opt-out, bottom sentinel before wrappers, signed tail-distance oracle, shrink sync snap. |
